...
public class FileController implements Serializable {
    ...
    @EJB
    private FileFacadeLocal ejbFacadeLocal;
    ...
    private FileFacadeLocal getFacade() {
        return ejbFacadeLocal;
    }

    public File prepareCreate() {
        selected = new File();
    ...
    public File getFile(java.lang.Long id) {
        return getFacade().find(id);
    }

    public List<File> getItemsAvailableSelectMany() {
        return getFacade().findAll();
    }

    public List<File> getItemsAvailableSelectOne() {
        return getFacade().findAll();
    }
    ...
    public static class FileControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof File) {
                ...
                Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), File.class.getName()});
                return null;
            }
        }
