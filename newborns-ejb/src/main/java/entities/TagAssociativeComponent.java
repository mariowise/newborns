 ...
 */
@Entity
public class TagAssociativeComponent implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        TagAssociativeComponent other = (TagAssociativeComponent) object;
    ...
    public String toString() {
        return "entities.TagAssociativeComponent[ id=" + id + " ]";
    }
